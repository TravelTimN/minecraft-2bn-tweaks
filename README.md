...
A collection of **standalone crafting-recipe datapacks** that fill in the gaps left by vanilla. Each pack is a separate, optional install — pick and choose what you want, or use them all.
...
This datapack lets you craft **raw Nether Quartz** from three humble Nether blocks - no more grinding quartz veins (or haggling with piglins) for your blocks, comparators, and redstone.

Perfect for builders, redstoners, and anyone who'd rather spend their Nether time exploring than mining.

![craftable raw quartz](craftables/quartz/quartz.png)
