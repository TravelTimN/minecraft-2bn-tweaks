...
NAMESPACE = "elytra"
PACK_DESCRIPTION = "§42§cB§6N§f-§eT§aw§be§9a§5k§ds §f> §eCraftables §f: §bElytra"
BASE_PACK_FORMAT = 15
MAX_PACK_FORMAT = 121.0
DECIMAL_PACK_FORMAT_START = 82

RECIPE_NAME = NAMESPACE
OUTPUT_ITEM = f"minecraft:{NAMESPACE}"
OUTPUT_COUNT = 1
...
for pack in all_packs:
    ...
    print(f"  - {label:<12}: elytra created")
